# Simple example optimising residential building operation.
...
Input_data.m  - Define problem data and read data from 			the excel file data_problem.xlsx. All the  			data are saved in the file 						`case_study_sim.mat'. The stored data in 				`case_study­_sim.mat' are uploaded and used by 			the optimisation model.
